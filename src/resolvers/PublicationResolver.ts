...
class PublicationResolver {
  ...
  @Query((_returns) => Publication, {
    nullable: true,
    description: 'Returns a single <Publication> via a given <id>',
  })
  ...
  @Query((_returns) => Publication, {
    nullable: true,
    description: 'Returns a single <Publication> via a given <slug>',
  })
  ...
  @Query((_returns) => [Publication], {
    description: 'Returns a list of <Publications> via a given list of <ids>',
  })
  ...
  @FieldResolver((_returns) => Article, {
    nullable: true,
    description: 'The most recent <Article> of a <Publication>',
  })
  ...
  @FieldResolver((_returns) => Number, {
    description: "The total shoutouts of a <Publication's> <Articles>",
  })
  ...
  @FieldResolver((_returns) => Number, {
    description: 'The total number of <Articles> from a <Publication>',
  })
